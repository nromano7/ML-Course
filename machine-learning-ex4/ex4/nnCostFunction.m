...
% calculate activations for layer 2 and 3
a2 = sigmoid(X*Theta1');
a2 = [ones(size(a2,1),1) a2];
a3 = sigmoid(a2*Theta2');
h_theta = a3;

% map y into binary vector
...
J = sum(((1/m)*sum(-y_vect.*log(h_theta)-(1-y_vect).*log(1-h_theta))));

% calculate cost with regularization (igonoring the bias unit)
Theta1_temp = Theta1;
Theta1_temp(:,1) = 0;
Theta2_temp = Theta2;
Theta2_temp(:,1) = 0;
